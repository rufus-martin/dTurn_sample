...
public class Controlcenter {
    ...
    public static UploadResponse handleFileUpload(DReqObj reqObj, String projectId, String filePath,Long studyId) {
                ...
                if (project != null && project.getTaskType() != null) {
                    ...
                    switch (project.getTaskType()) {
                        ...
                        case IMAGE_POLYGON_BOUNDING_BOX_V2:
                            response = DataUploadHandler.handleImagePolygonBoundingBox(reqObj,  project, filePath,studyId);
                            break;
